                    ...
                    <div class="row">
                        <div class="col col-lg-12 pr-4">
                            ...
                            <div class="col-md-12 text-center update-pass">
                                <button type="submit" class="btn mt-3 btn2 change_password_btn">Update Password <span class="change_pass_fa_spin_icon"></span></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="change_password_emp" style="background: rgba(46, 29, 204, 0.14); padding-right: 5px;">
    <div class="modal-dialog modal-md custom-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title p-2">Change Password</h5>
...
//input[name="doj"]
        ...
        $('input[name="established_date"],input[name="goal_freeze_time"],input[name="rating_freeze_time"]').daterangepicker({
            singleDatePicker: true,
            showDropdowns: true,
            locale: {
                format: 'DD-MM-YYYY'
...
<script>
    $(document).ready(function () {
        ...
        $('#edit-searchable-select').select2();
    });
