   ...
   <div class="content">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tbody class="text-center">
                           <tr>
                              ...
                              <td><?= $user['email']; ?></td>
                              <td>
    <?= $user['group_id'] == 2 ? 'Restaurant Admin' : 'Restaurant Employee'; ?>
</td>
    ...
    <b><?= $user['active'] == 1 ? 'Enabled' : 'Disabled'; ?></b>
                              ...
                              <td>
                                 ...
                                 <span data-toggle="modal" data-target="#editUser" title="Edit User" class="icon-edit-delete editText" data-user-id="">
                                 ...
                                 <i class="fas fa-ban text-danger cursor-pointer" 
                                    ...
                                    onclick="setDeleteUserData(<?= $user['user_id']; ?>, '<?= $user['first_name']; ?>')">
                                    </i>
                                 </span>
                              </td>
                           </tr>
   ...
   <div class="modal-dialog modal-lg h-auto">
      <div class="modal-content modal-content-customize">
         ...
         <div class="modal-body">
            <form id="addCategoryForm"  action="<?= base_url('Dashboard/create_user') ?>" method="POST">
               <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Select Restaurant Name<a style="color: red">*</a></label>
                        <select name="company_id" id="companySelect" class="form-control" required>
                            <option value="" disabled selected>Select</option>
                            <?php foreach ($companies as $company): ?>
                                <option value="<?= $company->comp_onboarding_id; ?>"><?= $company->company_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        <label for="user_type">Select User Type <a style="color: red">*</a></label>
                        <select name="user_type" id="userTypeSelect" class="form-control" required onchange="toggleFieldsUserType()">
                            <option value="" disabled selected>Select</option>
                            <option value="admin">Restaurant Admin</option>
                            <option value="user">Restaurant Employee</option>
                        </select>
                    </div>
                  </div>
                <!-- Additional fields (initially hidden) -->
                <div class="row mx-0 w-100" id="userFields" style="display: none;">
                <div class="col-md-12">
    <div class="form-group">
        <label for="restaurantSelect">Select Restaurant <a style="color: red">*</a></label>
         ...
         <div class="modal-body">
            <form id="editUserForm" action="" method="POST">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Select Restaurant <a style="color: red">*</a></label>
                        <select name="user_type" id="" class="form-control" required >
                            <option value="" disabled selected>Select</option>
                            <option value="admin">Restaurant 1</option>
                            <option value="user">Restaurant 2</option>
                        </select>
                     </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                        <label for="user_type">Select User Type<a style="color: red">*</a></label>
                        <select name="user_type" id="editUserTypeSelect" class="form-control" required onchange="editToggleFieldsUserType()">
                            <option value="" disabled selected>Select</option>
                            <option value="edit_admin">Restaurant Admin</option>
                            <option value="edit_user">Restaurant Employee</option>
                        </select>
                    </div>
                  </div>
                <!-- Additional fields (initially hidden) -->
                <div class="row mx-0 w-100" id="editUserFields" style="display: none;">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="admin_code">Select Location <a style="color: red">*</a></label>
...
<script>
function toggleFieldsUserType() {
    let userType = document.getElementById("userTypeSelect").value;

    // Only show the "User Details" field if "Restaurant Employee" is selected
    document.getElementById("userFields").style.display = (userType === "user") ? "block" : "none";
}

    function editToggleFieldsUserType() {
        let editUserType = document.getElementById("editUserTypeSelect").value;
        
        document.getElementById("editUserFields").style.display = (editUserType === "edit_user") ? "inline-flex" : "none";
    }
...
document.getElementById('companySelect').addEventListener('change', function() {
    ...
    if (companyId) {
        // Make an AJAX request to fetch restaurants for the selected company
        fetch('<?= base_url('Dashboard/get_restaurant_by_company_id'); ?>', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            restaurantSelect.innerHTML = '<option value="" disabled selected>Select Restaurant</option>'; // Reset options
...
//     if (restaurantId) {
//         // Make an AJAX request to fetch locations for the selected restaurant
//         fetch('<?= site_url('usercontroller/get_locations'); ?>', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/x-www-form-urlencoded',
//             },
...
//             locationSelect.innerHTML = '<option value="" disabled selected>Select Location</option>'; // Reset options
