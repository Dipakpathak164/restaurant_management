...
<body
    ...
    <table role=“presentation” bgcolor="#fff" style="background-color: #fff" width="750" border="0" align="center"
        ...
        <tbody bgcolor="#fff">
            ...
            <tr>
                <td align="center">
                    <table bgcolor="#fff" style="position: relative;" class="col-700" width="750" border="0"
                        align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <table bgcolor="#fff" style="background-color: #fff;" class="col-700" width="750"
                                        border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                <td align="left" style="padding: 55px 90px 0px 90px;">
                                                    <img src="<?php echo IMAGE_PATH?>logo.png" height="auto" alt="logo" width="100px" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <tr>
                <td align="center" bgcolor="#FFFFFF" style="background-color: #FFFFFF">
                    <table bgcolor="#23233f" style="background-color: #23233f" class="col-700" width="750" border="0"
                        align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <table bgcolor="#FFFFFF" style="background-color: #FFFFFF;margin: 0;" class="col-700"
                                        width="750" border="0" align="left" cellpadding="0" cellspacing="0" border-spacing="0">
                                        <tr align="left">
                                            <td style="padding: 0 90px 40px 90px" align="left" width="100%">
                                                <h4 class="text-color font-semi-bold" style="font-size: 18px;margin-top: 18px;margin-bottom: 0px;">Dear <?php echo $first_name?></h4>
                                              
                                                <p class="text-color"></p>
                                                <p class="text-color"><?php echo $message?></p>
                                                <p class="text-color">
                                                   Best Regards, <br>
                                                  <a href="<?php echo base_url()?>" style="color: #505050;text-decoration: none;"> venkatesh.iyer@viaaapl.com</a>
                                                </p>
