<div class="container">
    <div class="row">
        <div class="col-md-12 text-center top_logo">
            <img src="<?php echo IMAGE_PATH?>Black-Logo.webp" alt="Black-Logo" width="450">
        </div>
        <div class="col-md-8 mx-auto quest_form_outer">
            <form action="<?= base_url('Welcome/company_onboarding') ?>" class="question_form" method="post">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="restaurant_count" name="restaurant" min="1" required>
                            </div>
                        </div>
...
<div class="col-md-6 mb-3">
   ...
   <input type="text" name="revenue_jan_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>February Target (current year)</label>
   <input type="text" name="revenue_feb_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>March Target (current year)</label>
   <input type="text" name="revenue_march_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>April Target (current year)</label>
   <input type="text" name="revenue_apr_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>May Target (current year)</label>
   <input type="text" name="revenue_may_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>June Target (current year)</label>
   <input type="text" name="revenue_jun_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>July Target (current year)</label>
   <input type="text" name="revenue_july_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>August Target (current year)</label>
   <input type="text" name="revenue_aug_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>September Target (current year)</label>
   <input type="text" name="revenue_sep_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>October Target (current year)</label>
   <input type="text" name="revenue_oct_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>November Target (current year)</label>
   <input type="text" name="revenue_nov_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-6 mb-3">
   <label>December Target (current year)</label>
   <input type="text" name="revenue_dec_target_${i}" class="form-control" placeholder="e.g., 23">
</div>
<div class="col-md-12">
   <h3>Labor Target</h3>
</div>
